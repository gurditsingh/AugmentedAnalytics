...
import charts
import utils
import  centraltendency as ct
import CategoryFucntion as cf

df=pd.read_csv("E:\\LearnItFirst\\JAVA DART\\data_science\\train.txt")
print(df.columns)
...
print(univariate(df,'Store',chart=True).head())
